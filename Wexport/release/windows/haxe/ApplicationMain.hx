...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("coding tutorial", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("coding tutorial", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "coding tutorial";
		app.meta["name"] = "FNF coding tutorial";
